...
import * as _i_signatures from "../../../../../interface/generated/pareto/schemas/html-print/marshall"
...
export const Span: _i_signatures._T_Span = ($, $p) => ['verbose group', _pa.dictionary_literal({
    ...
    'title': _pa.cc($['title'], ($) => ['optional', $.transform(
...
export const Div: _i_signatures._T_Div = ($, $p) => ['verbose group', _pa.dictionary_literal({
    'classes': _pa.cc($['classes'], ($) => Classes(
        $,
        {
            'value serializers': $p['value serializers'],
